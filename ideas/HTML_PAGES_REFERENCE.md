...
#### index-en.html
- **Path:** `/index-en`
- **File:** `src/main/webapp/index-en.html`
...
- **File:** `src/main/webapp/already-logged-in.html`
...
- **File:** `src/main/webapp/user-information.html`
...
- **Source:** `src/main/scala/code/model/dataAccess/AuthUser.scala`
...
- **File:** `src/main/webapp/user-invitation.html`
...
- **File:** `src/main/webapp/user-invitation-info.html`
...
- **File:** `src/main/webapp/user-invitation-invalid.html`
...
- **File:** `src/main/webapp/user-invitation-warning.html`
...
- **File:** `src/main/webapp/oauth/authorize.html`
...
- **File:** `src/main/webapp/oauth/thanks.html`
...
#### consent-screen.html
- **Path:** `/consent-screen`
- **File:** `src/main/webapp/consent-screen.html`
...
#### consents.html
- **Path:** `/consents`
- **File:** `src/main/webapp/consents.html`
...
- **File:** `src/main/webapp/confirm-bg-consent-request.html`
...
- **File:** `src/main/webapp/confirm-bg-consent-request-sca.html`
...
- **File:** `src/main/webapp/confirm-bg-consent-request-redirect-uri.html`
...
- **File:** `src/main/webapp/confirm-vrp-consent-request.html`
...
- **File:** `src/main/webapp/confirm-vrp-consent.html`
...
- **File:** `src/main/webapp/consumer-registration.html`
...
- **File:** `src/main/webapp/dummy-user-tokens.html`
...
- **File:** `src/main/webapp/create-sandbox-account.html`
...
- **File:** `src/main/webapp/add-user-auth-context-update-request.html`
...
- **File:** `src/main/webapp/confirm-user-auth-context-update-request.html`
...
- **File:** `src/main/webapp/terms-and-conditions.html`
...
#### privacy-policy.html
- **Path:** `/privacy-policy`
- **File:** `src/main/webapp/privacy-policy.html`
...
#### sdks.html
- **Path:** `/sdks`
- **File:** `src/main/webapp/sdks.html`
...
#### static.html
- **Path:** `/static`
- **File:** `src/main/webapp/static.html`
...
- **File:** `src/main/webapp/main-faq.html`
...
#### debug.html
- **Path:** `/debug`
- **File:** `src/main/webapp/debug.html`
...
#### debug/awake.html
- **Path:** `/debug/awake`
- **File:** `src/main/webapp/debug/awake.html`
...
- **File:** `src/main/webapp/debug/debug-basic.html`
...
- **File:** `src/main/webapp/debug/debug-default-header.html`
...
- **File:** `src/main/webapp/debug/debug-default-footer.html`
...
- **File:** `src/main/webapp/debug/debug-localization.html`
...
- **File:** `src/main/webapp/debug/debug-plain.html`
...
- **File:** `src/main/webapp/debug/debug-webui.html`
...
- **File:** `src/main/webapp/templates-hidden/_login.html`
...
- **File:** `src/main/scala/bootstrap/liftweb/Boot.scala`
...
- **Boot Configuration:** `src/main/scala/bootstrap/liftweb/Boot.scala`
...
- **User Management:** `src/main/scala/code/model/dataAccess/AuthUser.scala` (password reset, validation)
- **Password Reset API:** `src/main/scala/code/api/v4_0_0/APIMethods400.scala` (resetPasswordUrl endpoint)