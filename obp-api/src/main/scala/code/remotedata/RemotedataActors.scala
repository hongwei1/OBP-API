...
object RemotedataActors extends MdcLoggable {
  ...
  def startActors(actorSystem: ActorSystem) = {
    ...
    val actorsRemotedata = Map(
      ...
      ActorProps[RemotedataChallengesActor]           -> RemotedataChallenges.actorName,
      ...
      ActorProps[RemotedataUserAuthContextUpdateActor]      -> RemotedataUserAuthContextUpdate.actorName,
      ...
      ActorProps[RemotedataUserAttributeActor]        -> RemotedataUserAttribute.actorName
    )
