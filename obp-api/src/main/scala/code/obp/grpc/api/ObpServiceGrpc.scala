...
object ObpServiceGrpc {
  ...
  val METHOD_GET_PRIVATE_ACCOUNTS_AT_ONE_BANK: _root_.io.grpc.MethodDescriptor[code.obp.grpc.api.BankIdUserIdGrpc, code.obp.grpc.api.AccountsGrpc] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setSampledToLocalTracing(true)
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[code.obp.grpc.api.BankIdUserIdGrpc])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[code.obp.grpc.api.AccountsGrpc])
      .setSchemaDescriptor(_root_.scalapb.grpc.ConcreteProtoMethodDescriptorSupplier.fromMethodDescriptor(code.obp.grpc.api.ApiProto.javaDescriptor.getServices().get(0).getMethods().get(1)))
      .build()
  ...
  val METHOD_GET_BANK_ACCOUNTS_BALANCES: _root_.io.grpc.MethodDescriptor[code.obp.grpc.api.BankIdGrpc, code.obp.grpc.api.AccountsBalancesV310JsonGrpc] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setSampledToLocalTracing(true)
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[code.obp.grpc.api.BankIdGrpc])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[code.obp.grpc.api.AccountsBalancesV310JsonGrpc])
      .setSchemaDescriptor(_root_.scalapb.grpc.ConcreteProtoMethodDescriptorSupplier.fromMethodDescriptor(code.obp.grpc.api.ApiProto.javaDescriptor.getServices().get(0).getMethods().get(2)))
      .build()
  ...
  val METHOD_GET_CORE_TRANSACTIONS_FOR_BANK_ACCOUNT: _root_.io.grpc.MethodDescriptor[code.obp.grpc.api.BankIdAccountIdAndUserIdGrpc, code.obp.grpc.api.CoreTransactionsJsonV300Grpc] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setSampledToLocalTracing(true)
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[code.obp.grpc.api.BankIdAccountIdAndUserIdGrpc])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[code.obp.grpc.api.CoreTransactionsJsonV300Grpc])
      .setSchemaDescriptor(_root_.scalapb.grpc.ConcreteProtoMethodDescriptorSupplier.fromMethodDescriptor(code.obp.grpc.api.ApiProto.javaDescriptor.getServices().get(0).getMethods().get(3)))
      .build()
  ...
  object ObpService extends _root_.scalapb.grpc.ServiceCompanion[ObpService] {
    ...
    def bindService(serviceImpl: ObpService, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
      ...
      .addMethod(
        ...
        _root_.io.grpc.stub.ServerCalls.asyncUnaryCall((request: code.obp.grpc.api.BankIdUserIdGrpc, observer: _root_.io.grpc.stub.StreamObserver[code.obp.grpc.api.AccountsGrpc]) => {
      ...
      .addMethod(
        ...
        _root_.io.grpc.stub.ServerCalls.asyncUnaryCall((request: code.obp.grpc.api.BankIdGrpc, observer: _root_.io.grpc.stub.StreamObserver[code.obp.grpc.api.AccountsBalancesV310JsonGrpc]) => {
      ...
      .addMethod(
        ...
        _root_.io.grpc.stub.ServerCalls.asyncUnaryCall((request: code.obp.grpc.api.BankIdAccountIdAndUserIdGrpc, observer: _root_.io.grpc.stub.StreamObserver[code.obp.grpc.api.CoreTransactionsJsonV300Grpc]) => {
  ...
  class ObpServiceBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[ObpServiceBlockingStub](channel, options) with ObpServiceBlockingClient {
    ...
    override def getPrivateAccountsAtOneBank(request: code.obp.grpc.api.BankIdUserIdGrpc): code.obp.grpc.api.AccountsGrpc = {
      _root_.scalapb.grpc.ClientCalls.blockingUnaryCall(channel, METHOD_GET_PRIVATE_ACCOUNTS_AT_ONE_BANK, options, request)
    }
    
    /** Get the Balances for the Accounts of the current User at one bank.
      */
    override def getBankAccountsBalances(request: code.obp.grpc.api.BankIdGrpc): code.obp.grpc.api.AccountsBalancesV310JsonGrpc = {
      _root_.scalapb.grpc.ClientCalls.blockingUnaryCall(channel, METHOD_GET_BANK_ACCOUNTS_BALANCES, options, request)
    }
    ...
    override def getCoreTransactionsForBankAccount(request: code.obp.grpc.api.BankIdAccountIdAndUserIdGrpc): code.obp.grpc.api.CoreTransactionsJsonV300Grpc = {
      _root_.scalapb.grpc.ClientCalls.blockingUnaryCall(channel, METHOD_GET_CORE_TRANSACTIONS_FOR_BANK_ACCOUNT, options, request)
    }
  ...
  class ObpServiceStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[ObpServiceStub](channel, options) with ObpService {
    ...
    override def getPrivateAccountsAtOneBank(request: code.obp.grpc.api.BankIdUserIdGrpc): scala.concurrent.Future[code.obp.grpc.api.AccountsGrpc] = {
      _root_.scalapb.grpc.ClientCalls.asyncUnaryCall(channel, METHOD_GET_PRIVATE_ACCOUNTS_AT_ONE_BANK, options, request)
    }
    ...
    override def getBankAccountsBalances(request: code.obp.grpc.api.BankIdGrpc): scala.concurrent.Future[code.obp.grpc.api.AccountsBalancesV310JsonGrpc] = {
      _root_.scalapb.grpc.ClientCalls.asyncUnaryCall(channel, METHOD_GET_BANK_ACCOUNTS_BALANCES, options, request)
    }
    ...
    override def getCoreTransactionsForBankAccount(request: code.obp.grpc.api.BankIdAccountIdAndUserIdGrpc): scala.concurrent.Future[code.obp.grpc.api.CoreTransactionsJsonV300Grpc] = {
      _root_.scalapb.grpc.ClientCalls.asyncUnaryCall(channel, METHOD_GET_CORE_TRANSACTIONS_FOR_BANK_ACCOUNT, options, request)
    }
