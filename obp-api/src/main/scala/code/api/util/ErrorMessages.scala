...
object ErrorMessages {
  ...
  val SystemViewsCanNotBeModified = "OBP-20021: System Views cannot be modified. Only the created views can be modified."
  ...
  val BranchNotFoundByBranchId = "OBP-300010: Branch not found. Please specify a valid value for BRANCH_ID. Or License may not be set. meta.license.id and meta.license.name cannot be empty"
  ...
  val CounterpartyBeneficiaryPermit = "OBP-30013: The account cannot send money to the Counterparty. Please set the Counterparty 'isBeneficiary' true first"
  ...
  val CardNotFound = "OBP-30059: This Card cannot be found for the user "
  ...
  val UpdateAccountApplicationStatusError = "OBP-30315: AccountApplication Status cannot be updated. "
  val CreateAccountApplicationError = "OBP-30316: AccountApplication Status cannot be created. "
  ...
  val SmsServerNotResponding = "OBP-35010: SMS server is not working or SMS server cannot send the message to the phone number: "
  ...
  val DynamicResourceDocDeleteError = "OBP-40041: DynamicResourceDoc cannot be deleted. "
  ...
  val DynamicMessageDocDeleteError = "OBP-40044: DynamicMessageDoc cannot be deleted. "
  ...
  val CurrentUserNotFoundException = "OBP-50004: Method (AuthUser.getCurrentUser) cannot find the current user in the current context!"
  ...
  val NoCallContext = "OBP-50012: Cannot get the CallContext object here."
  val UnspecifiedCbsError = "OBP-50013: The Core Banking System returned an unspecified error or response."
  val RefreshUserError = "OBP-50014: Cannot refresh User."
