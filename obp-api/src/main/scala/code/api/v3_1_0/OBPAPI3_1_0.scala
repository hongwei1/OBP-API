...
import code.api.util.APIUtil.{OBPEndpoint, ResourceDoc, authorizedAccess, getAllowedEndpoints}
...
import code.api.v3_1_0.JSONFactory310.createMeetingsJson
import code.util.Helper.MdcLoggable
import com.openbankproject.commons.model.BankId
import net.liftweb.common.Full

import scala.collection.immutable.Nil
import code.api.util.APIUtil.scalaFutureToBoxedJsonResponse
...
object OBPAPI3_1_0 extends OBPRestHelper with APIMethods130 with APIMethods140 with APIMethods200 with APIMethods210 with APIMethods220 with APIMethods300 with CustomAPIMethods300 with APIMethods310 with MdcLoggable {
  ...
  oauthServe(genericEndpoint, None)
