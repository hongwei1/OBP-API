...
object Http4sUKOBv310StandingOrders extends MdcLoggable {
  ...
  private def parseBody(s: String): code.api.util.JvalueCaseClass = code.api.util.JvalueCaseClass(com.openbankproject.commons.util.JsonAliases.parse(s).asInstanceOf[org.json4s.JObject])
