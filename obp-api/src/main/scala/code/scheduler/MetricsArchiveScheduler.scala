...
object MetricsArchiveScheduler extends MdcLoggable {
  ...
  private case class MetricRow(
    ...
    certificateTrustDetail: Option[String]
  ) extends APIMetric {
    ...
    override def getCertificateTrust(): String = certificateTrust.orNull
    override def getCertificateTrustDetail(): String = certificateTrustDetail.orNull
  }
