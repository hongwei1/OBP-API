...
// ATM persistence is Doobie-backed (the Lift MappedAtm entity has been removed); this saveable
// routes the batch import through the active AtmsProvider (DoobieAtmsProvider) instead of Mapper.save.
