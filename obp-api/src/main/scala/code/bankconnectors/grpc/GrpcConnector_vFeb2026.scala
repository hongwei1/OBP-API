...
trait GrpcConnector_vFeb2026 extends Connector with MdcLoggable {
...
// ---------- created on 2026-09-12T12:50:48Z
...
//---------------- dynamic end ---------------------please don't modify this line  
  ...
  private[this] def sendRequest[T <: InBoundTrait[_]: TypeTag : Manifest](process: String, outBound: TopicTrait, callContext: Option[CallContext]): Future[Box[T]] = {
    ...
    GrpcUtils
      .sendRequest[T](process, outBound)
...
object GrpcConnector_vFeb2026 extends GrpcConnector_vFeb2026
