package code.bankconnectors.vApril2019
...
trait KafkaMappedConnector_vApril2019 extends Connector with KafkaHelper with MdcLoggable {
  
  implicit override val nameOfConnector = KafkaMappedConnector_vApril2019.toString
  ...
  val messageFormat: String = "April2019"
  ...
  def getAuthInfo (callContext: Option[CallContext]): Box[AuthInfo]=
    for{
      ...
      AuthInfo(currentResourceUserId, username, consumerId,cbs_token, isFirst, correlationId, sessionId, likedCustomersBasic, basicUserAuthContexts, authViews)
    }
...
object KafkaMappedConnector_vApril2019 extends KafkaMappedConnector_vApril2019{
