...
object ErrorMessages {
  ...
  val NoCreditCard = "ADAPTER-60000: No valid credit card or no credit card with sufficient withdrawal limit found. "
  val JoniCacheEmpty = "ADAPTER-60001: Joni Cache return empty, do not cache it before! "
  val JoniFailed = "ADAPTER-60002: Joni Call to CBS failed. "
