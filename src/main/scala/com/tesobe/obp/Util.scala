...
object ErrorMessages {
  ...
  val NoCreditCard = "OBP-ADAPTER-60000: No valid credit card or no credit card with sufficient withdrawal limit found. "
  val JoniCacheEmpty = "OBP-ADAPTER-60001: Joni Cache return empty, do not cache it before! "
  val JoniFailed = "OBP-ADAPTER-60002: Joni Call to CBS failed. "
  val SessionError = "OBP-ADAPTER-60003: Invalid Session. "
  val InvalidMobilNumber = "OBP-ADAPTER-60004: Invalid Mobile Number, we only support Israel country code. It should start as :+972xxxxxxxxx ."
  val InvalidAccountId = "OBP-ADAPTER-60005: Invalid AccountId, the following Account Id is not in Joni cache. "
  val InvalidRequestFormat = "OBP-ADAPTER-60006: Invalid Request Format: Parameter for Backendcall not in malformated."
  val InvalidCounterPartyId = "OBP-ADAPTER-60007: Invalid or uncached counterpartyId. "
  val MainFrameError = "OBP-ADAPTER-60008: Main Frame Error ."
  val InvalidPassportOrNationalId = "OBP-ADAPTER-60009: Invalid Passport or National ID number"
  val InvalidAmount = "OBP-ADAPTER-60010: Invalid Amount"
  val InvalidIdType = "OBP-ADAPTER-60011: Invalid Id Type: valid types: 1 - National; 5- Passport"
  val mFTokenMatchError = "OBP-ADAPTER-60012: Session error - cbs_token from North side does not match MFTOKEN from South side."
  val EmptyUsernameError = "OBP-ADAPTER-60013: Request was sent with empty username."
  val InvalidTime = "OBP-ADAPTER-60014: Invalid time or time format."
  val CounterpartyIdNotCached = "OBP-ADAPTER-60015: CounterpartyId not in Cache."
  val InvalidTransferType = "OBP-ADAPTER-60016: Invalid TransferType: valid types: regular, RealTime"
