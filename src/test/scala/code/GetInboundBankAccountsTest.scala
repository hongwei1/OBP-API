...
class GetInboundBankAccountsTest extends FunSuite with Matchers {
  ...
  test("getFullBankAccounts extracts FullBankAccounts" ) {
    ...
    accounts should be(List(
      FullBankAccount(BasicBankAccount("3565953", "616", "330", "<M/          81433020102612", AccountPermissions(true,false,false)),"IL230106160000050180963","5668.13", "15000"),
      FullBankAccount(BasicBankAccount("50180983", "616", "430", "<M/          81433020102612", AccountPermissions(true,false,true)),"IL230106160000050180963","5668.13", "15000"),
      FullBankAccount(BasicBankAccount("50180963", "616", "330", "<M/          81433020102612", AccountPermissions(true,false,false)),"IL230106160000050180963","5668.13", "15000"),
      ...
      FullBankAccount(BasicBankAccount("20102612", "814", "330", "<M/          81433020102612", AccountPermissions(true,false,false)),"IL230106160000050180963","5668.13", "15000"),
      ...
      FullBankAccount(BasicBankAccount("20105505", "814", "330", "<M/          81433020102612", AccountPermissions(true,false,false)),"IL230106160000050180963","5668.13", "15000")
    ))
    }
