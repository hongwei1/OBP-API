...
class LeumiDecoderTest extends FunSuite with Matchers{
  ...
  test("getBankAccounts works for HttpStub"){
    val result = getBankAccounts(GetAccounts(AuthInfo("karlsid", "karl", "")))

    //Balance is from nt1c call, all accounts use the same json HttpStub => all accounts have the same balance
    result should be (InboundBankAccounts(AuthInfo("karlsid", "karl", "<M/          81433020102612"),
      List(InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "616", accountId1, "3565953", "330", "5668.13", "ILS", List(""), List("Auditor"), "", "", "", "", "", ""),
        InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "616", accountId2, "50180983", "430", "5668.13", "ILS", List("./src/test/resources/joni_result.json"), List("Owner"), "", "", "", "", "", ""), 
        InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "616", accountId3, "50180963", "330", "5668.13", "ILS", List(""), List("Auditor"), "", "", "", "", "", ""),
        InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "814", accountId4, "20102612", "330", "5668.13", "ILS", List(""), List("Auditor"), "", "", "", "", "", ""),
        InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "814", accountId5, "20105505", "330", "5668.13", "ILS", List(""), List("Auditor"), "", "", "", "", "", ""))))
  }
  
  test("getBankAccountbyAccountId works for HttpStub"){
    val result = getBankAccountbyAccountId(GetAccountbyAccountID(AuthInfo("karlsid", "karl", ""),"10",accountId1))
    result should be (InboundBankAccount(AuthInfo("karlsid", "karl", "<M/          81433020102612"),(InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "616", accountId1, "3565953", "330", "5668.13", "ILS", List(""), List("Auditor"), "", "", "", "", "", ""))))
  }

  test("getBankAccountbyAccountNumber works for HttpStub"){
    val result = getBankAccountByAccountNumber(GetAccountbyAccountNumber(AuthInfo("karlsid", "karl", ""),"10","3565953"))
    result should be (InboundBankAccount(AuthInfo("karlsid", "karl", "<M/          81433020102612"),(InboundAccountJune2017("errorcode", "<M/          81433020102612", "10", "616", accountId1, "3565953", "330", "5668.13", "ILS", List(""), List("Auditor"), "", "", "", "", "", ""))))
  }
  
  test("getTransactions works for HttpStubs first transaction"){
